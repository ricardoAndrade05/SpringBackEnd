package com.nelioalves.coursomc.services.validation.utils;
...
public class BR {
     ...
     * Valida CNPJ
     */
    public static boolean isValidCNPJ(String cnjp) {
        if (cnjp == null || !cnjp.matches("\\d{14}")) return false;
        return check(cnjp, 12, WEIGHT_TFN);
    }
